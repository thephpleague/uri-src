...
final class TypeConverterTest extends TestCase
{
    ...
    {
        self::assertNull(
            TypeConverter::toEnum('foo', 'UnknownEnum'), /* @phpstan-ignore-line */
        );
    }
    ...
    public function testToDateTimeImmutableReturnsNullForEmptyFormat(): void
    {
        self::assertNull(
            TypeConverter::toDateTimeImmutable(
                '2026-09-18',
    ...
    public function testToDateTimeImmutableRejectsInvalidDates(
        ...
        self::assertNull(
            TypeConverter::toDateTimeImmutable($value, $format),
        );
    }
