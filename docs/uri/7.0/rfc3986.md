...
Please find below an quick explanation of each method.
...
Resolves a URI using the rules from [RFC6570](http://tools.ietf.org/html/rfc6570):
...
This method expects at most two parameters. The URI template to resolve and the variables
use for resolution. You can get a more in-depth understanding of
...
### Using a Microsoft Windows file path
